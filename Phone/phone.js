...
var phoneData =[
  ...
  name: "Samsung - Galaxy A12 32GB(Unlocked) - Black",
  ...
  name: "Apple - Preowned iPhone X with 256GB Memory Cell Phone (Unlocked) - Space Gray",
  ...
  name: "Samsung - Galaxy S21 FE 5G 128GB (Unlocked) - Graphite",
...
localStorage.setItem("phonePage", JSON.stringify(phoneData));
...
phoneData.map( function(element, index){
